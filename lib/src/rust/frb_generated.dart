...
abstract class RustLibApi extends BaseApi {
  ...
  Future<Author> crateApiBridgeAuthor({required int id});
  ...
  Future<ApiCommentResponse> crateApiBridgeCommentV3(
      {required PlatformInt64 objType,
      required int objId,
      required PlatformInt64 page,
      required PlatformInt64 limit});

  Future<int> crateApiBridgeCommentV3Add(
      {required PlatformInt64 objType,
      required int objId,
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<Author> crateApiBridgeAuthor({required int id}) {
    return handler.executeNormal(NormalTask(
      ...
      codec: SseCodec(
        decodeSuccessData: sse_decode_author,
        decodeErrorData: sse_decode_AnyhowException,
      ),
      constMeta: kCrateApiBridgeAuthorConstMeta,
      argValues: [id],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiBridgeAuthorConstMeta => const TaskConstMeta(
        debugName: "author",
        argNames: ["id"],
      );
  ...
  Future<ApiCommentResponse> crateApiBridgeCommentV3(
    ...
    return handler.executeNormal(NormalTask(
      ...
      codec: SseCodec(
        decodeSuccessData: sse_decode_api_comment_response,
        decodeErrorData: sse_decode_AnyhowException,
      ),
      constMeta: kCrateApiBridgeCommentV3ConstMeta,
      argValues: [objType, objId, page, limit],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiBridgeCommentV3ConstMeta => const TaskConstMeta(
        debugName: "comment_v3",
        argNames: ["objType", "objId", "page", "limit"],
      );
  ...
  Future<int> crateApiBridgeCommentV3Add(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        sse_encode_i_32(objId, serializer);
        sse_encode_String(content, serializer);
        sse_encode_i_32(toCommentId, serializer);
        sse_encode_i_32(toUid, serializer);
        pdeCallFfi(generalizedFrbRustBinding, serializer,
      ...
      constMeta: kCrateApiBridgeCommentV3AddConstMeta,
      argValues: [objType, objId, content, toCommentId, toUid],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiBridgeCommentV3AddConstMeta => const TaskConstMeta(
        debugName: "comment_v3_add",
        argNames: ["objType", "objId", "content", "toCommentId", "toUid"],
      );
  ...
  Map<String, ApiComment> dco_decode_Map_String_api_comment_None(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return Map.fromEntries(dco_decode_list_record_string_api_comment(raw)
  ...
  ApiComment dco_decode_api_comment(dynamic raw) {
    ...
    return ApiComment(
      ...
      objId: dco_decode_String(arr[1]),
      content: dco_decode_String(arr[2]),
      senderIp: dco_decode_String(arr[3]),
      senderUid: dco_decode_String(arr[4]),
      isGoods: dco_decode_String(arr[5]),
      uploadImages: dco_decode_String(arr[6]),
      createTime: dco_decode_String(arr[7]),
      likeAmount: dco_decode_String(arr[8]),
      senderTerminal: dco_decode_String(arr[9]),
      originCommentId: dco_decode_String(arr[10]),
      nickname: dco_decode_String(arr[11]),
      userLevel: dco_decode_String(arr[12]),
      mPeriod: dco_decode_String(arr[13]),
      mCate: dco_decode_String(arr[14]),
      isFeeUser: dco_decode_bool(arr[15]),
      avatarUrl: dco_decode_String(arr[16]),
      sex: dco_decode_String(arr[17]),
      isLike: dco_decode_bool(arr[18]),
    );
  }
  ...
  ApiCommentResponse dco_decode_api_comment_response(dynamic raw) {
    ...
    return ApiCommentResponse(
      commentIds: dco_decode_list_String(arr[0]),
      comments: dco_decode_Map_String_api_comment_None(arr[1]),
  ...
  Author dco_decode_author(dynamic raw) {
    ...
    return Author(
      ...
      data: dco_decode_list_comic_in_author(arr[3]),
    );
  }
  ...
  List<ComicInAuthor> dco_decode_list_comic_in_author(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_comic_in_author).toList();
  }
  ...
  List<(String, ApiComment)> dco_decode_list_record_string_api_comment(
    ...
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>)
        .map(dco_decode_record_string_api_comment)
        .toList();
  }
  ...
  Map<String, ApiComment> sse_decode_Map_String_api_comment_None(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var inner = sse_decode_list_record_string_api_comment(deserializer);
  ...
  ApiComment sse_decode_api_comment(SseDeserializer deserializer) {
    ...
    var var_objId = sse_decode_String(deserializer);
    var var_content = sse_decode_String(deserializer);
    var var_senderIp = sse_decode_String(deserializer);
    var var_senderUid = sse_decode_String(deserializer);
    var var_isGoods = sse_decode_String(deserializer);
    var var_uploadImages = sse_decode_String(deserializer);
    var var_createTime = sse_decode_String(deserializer);
    var var_likeAmount = sse_decode_String(deserializer);
    var var_senderTerminal = sse_decode_String(deserializer);
    var var_originCommentId = sse_decode_String(deserializer);
    var var_nickname = sse_decode_String(deserializer);
    var var_userLevel = sse_decode_String(deserializer);
    var var_mPeriod = sse_decode_String(deserializer);
    var var_mCate = sse_decode_String(deserializer);
    var var_isFeeUser = sse_decode_bool(deserializer);
    var var_avatarUrl = sse_decode_String(deserializer);
    var var_sex = sse_decode_String(deserializer);
    var var_isLike = sse_decode_bool(deserializer);
    return ApiComment(
        id: var_id,
        objId: var_objId,
        content: var_content,
        ...
        senderTerminal: var_senderTerminal,
        originCommentId: var_originCommentId,
        nickname: var_nickname,
        userLevel: var_userLevel,
        mPeriod: var_mPeriod,
        mCate: var_mCate,
        isFeeUser: var_isFeeUser,
  ...
  ApiCommentResponse sse_decode_api_comment_response(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_commentIds = sse_decode_list_String(deserializer);
    var var_comments = sse_decode_Map_String_api_comment_None(deserializer);
    var var_total = sse_decode_i_64(deserializer);
    return ApiCommentResponse(
        commentIds: var_commentIds, comments: var_comments, total: var_total);
  }
  ...
  Author sse_decode_author(SseDeserializer deserializer) {
    ...
    var var_data = sse_decode_list_comic_in_author(deserializer);
    return Author(
        nickname: var_nickname,
  ...
  ComicInAuthor sse_decode_comic_in_author(SseDeserializer deserializer) {
    ...
    return ComicInAuthor(
        id: var_id, name: var_name, cover: var_cover, status: var_status);
  }
  ...
  List<ComicInAuthor> sse_decode_list_comic_in_author(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <ComicInAuthor>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_comic_in_author(deserializer));
    }
    return ans_;
  }
  ...
  List<(String, ApiComment)> sse_decode_list_record_string_api_comment(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <(String, ApiComment)>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_record_string_api_comment(deserializer));
    }
    return ans_;
  }
  ...
  (String, ApiComment) sse_decode_record_string_api_comment(
    ...
    var var_field1 = sse_decode_api_comment(deserializer);
  ...
  void sse_encode_Map_String_api_comment_None(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_list_record_string_api_comment(
  ...
  void sse_encode_api_comment(ApiComment self, SseSerializer serializer) {
    ...
    sse_encode_String(self.objId, serializer);
    sse_encode_String(self.content, serializer);
    sse_encode_String(self.senderIp, serializer);
    sse_encode_String(self.senderUid, serializer);
    sse_encode_String(self.isGoods, serializer);
    sse_encode_String(self.uploadImages, serializer);
    sse_encode_String(self.createTime, serializer);
    sse_encode_String(self.likeAmount, serializer);
    sse_encode_String(self.senderTerminal, serializer);
    sse_encode_String(self.originCommentId, serializer);
    sse_encode_String(self.nickname, serializer);
    sse_encode_String(self.userLevel, serializer);
    sse_encode_String(self.mPeriod, serializer);
    sse_encode_String(self.mCate, serializer);
    sse_encode_bool(self.isFeeUser, serializer);
    sse_encode_String(self.avatarUrl, serializer);
    sse_encode_String(self.sex, serializer);
    sse_encode_bool(self.isLike, serializer);
  }
  ...
  void sse_encode_api_comment_response(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_list_String(self.commentIds, serializer);
    sse_encode_Map_String_api_comment_None(self.comments, serializer);
  ...
  void sse_encode_author(Author self, SseSerializer serializer) {
    ...
    sse_encode_list_comic_in_author(self.data, serializer);
  }
  ...
  @protected
  void sse_encode_comic_in_author(
      ComicInAuthor self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
  ...
  void sse_encode_list_comic_in_author(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_comic_in_author(item, serializer);
    }
  }
  ...
  void sse_encode_list_record_string_api_comment(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_record_string_api_comment(item, serializer);
    }
  }
  ...
  void sse_encode_record_string_api_comment(
    ...
    sse_encode_api_comment(self.$2, serializer);
  }
